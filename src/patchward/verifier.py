...
class Verifier:
    ...
    Usage::
        ...
        result = verifier.verify(
            worktree_path=Path("/tmp/patchward-fix-abc123"),
    ...
    def __init__(self, timeout_seconds: int = 120) -> None:
        ...
        Args:
            timeout_seconds: Wall-clock timeout per gate subprocess call.
                             Configurable via patchward.toml [verifier] timeout_seconds.
    ...
    def _detect_test_runner(worktree_path: Path) -> str | None:
        ...
        # KS-TRACE: AC-P4-06, AC-P4-07, C-P4-04
        """
        # pytest — directory-based detection (covers patchward-fixture layout)
