...
# | assumption: repomend-scanner:0.1.0 has iptables + all scanner tools baked in
# | BASE_IMAGE updated to repomend-scanner:0.1.0 after image build + digest pin
...
# Base image — custom repomend-scanner image (ADR-014).
# python:3.12-slim is NOT sufficient: iptables binary absent, scanner tools absent.
# Built: 2026-06-12 | docker build -f docker/scanner.Dockerfile -t repomend-scanner:0.1.0 .
# ID pinned: docker inspect repomend-scanner:0.1.0 --format "{{.Id}}"
...
BASE_IMAGE = "repomend-scanner:0.1.0@sha256:578a8147c3604808a5c7e0f1649fc8e6a3a93610e02896d95cc36c388655a5bc"
...
# KS-TRACE: C-P2-04
from repomend.credential_proxy import _CREDENTIAL_KEYS  # noqa: E402
...
class NetworkPolicy(Enum):
    ...
    C-P3-08: iptables rules enforced inside container via repomend-scanner entrypoint.
