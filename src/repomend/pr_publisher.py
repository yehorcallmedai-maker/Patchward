...
if TYPE_CHECKING:
    ...
    from repomend.verifier import VerifierResult
...
class PRPublisher:
    ...
    def _build_pr_title(
        ...
        return f"fix({rule_id}): {short_desc} [repomend]"
    ...
    def _build_pr_body(
        ...
        sections = [
            ...
            "",
            "---",
            "_Opened automatically by [RepoMend](https://github.com). "
