...
"""
Shared git worktree primitives for repomend.worktree and repomend.fix_worktree.
...
Both worktree.py (scan path: repomend/scan-<id>) and fix_worktree.py
(fix path: repomend/fix-<finding-id>) import from here. Neither duplicates
...
def git_worktree_add(
    ...
    Args:
        ...
        branch:        Full branch name, e.g. 'repomend/scan-abc12345'
                       or 'repomend/fix-<finding-id>'.
